...
import java.util.ArrayList;
 ...
 public class Tela2 extends javax.swing.JFrame {
     ...
     private Tela_Codigo_Intermediario telaCodigoIntermediario = new Tela_Codigo_Intermediario(this,false); ;
    ...
    private void executaFunction(){
        ...
        while(!codigoIntermediario.get(ponteiroExec-1).getCodigo().equals("STP")){
